...
export const meta = {
  ...
  lastEdited: '2020-09-04T07:43:30.263Z',
  rank: 1,
}
...
To get started, [create an account on Kontent.ai](https://app.kontent.ai/sign-up?utm_source=vercel_guide&utm_medium=devrel&utm_campaign=extended_trial).
...
1. Install [Kontent Backup Manager](https://github.com/Kentico/kontent-backup-manager-js) and import data to newly created project from [kontent-backup.zip](https://github.com/vercel/next.js/raw/canary/examples/cms-kontent/kontent-backup.zip) file (place appropriate values for apiKey and projectId arguments):
...
<Caption>
  ...
  <a href="https://developers.google.com/speed/webp">moderm WebP format</a>.
</Caption>
